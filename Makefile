...
SRC = logsim.cc names.cc scanner.cc network.cc parser.cc monitor.cc devices.cc userint.cc gui.cc gui_monitor.cc guitest.cc guiCanvas.cc

L_OBJECTS = logsim.o names.o scanner.o network.o parser.o monitor.o devices.o userint.o gui.o guiCanvas.o gui_monitor.o error.o

G_OBJECTS = guitest.o names.o network.o monitor.o devices.o gui.o gui_monitor.o guiCanvas.o
...
guitest: $(G_OBJECTS)
	$(CXX) -o guitest $(G_OBJECTS) `wx-config --version=3.0 --libs std,aui --gl_libs` -lglut -lGL -lGLU$(OPENGL_LIBS)
...
gui.o: gui.h gui_monitor.h gui_constants.h names.h devices.h network.h monitor.h guiCanvas.h
gui_monitor.o: gui_monitor.h guiCanvas.h gui.h gui_constants.h names.h devices.h network.h monitor.h
guiCanvas.o: gui.h gui_constants.h names.h devices.h monitor.h
guitest.o: guitest.h names.h devices.h network.h monitor.h gui.h guiCanvas.h
